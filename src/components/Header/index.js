...
const Header = props => {
  ...
  return (
    <Navbar collapseOnSelect expand="lg" sticky="top" className ="backgroundNavbar"  variant="light">
  ...
  <Navbar.Collapse id="responsive-navbar-nav">
    ...
    <Nav.Link>Home</Nav.Link>
      ...
      <Nav.Link eventKey={2}>
        <button className="LogoutBtn" type="button" onClick={onClickLogout}>Logout</button>
      </Nav.Link>
    </Nav>
  </Navbar.Collapse>
  </Container>
