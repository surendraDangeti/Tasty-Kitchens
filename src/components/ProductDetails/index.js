          ...
          return (
            ...
            <div className="Food-item-list-container">
              <ul className="Food-item-list">
                ...
                <SimilarFoodItem similarFoodData = {eachFooditem} changeBtnStatus = {this.changeBtnStatus} quantity={this.state.quantity} key = {eachFooditem.id} onIncrementQuantity = {this.onIncrementQuantity} onDecrementQuantity= {this.onDecrementQuantity}
                  onIncrementTempQuantity = {this.onIncrementTempQuantity} onDecrementTempQuantity = {this.onDecrementTempQuantity}
